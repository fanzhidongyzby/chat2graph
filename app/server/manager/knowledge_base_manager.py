...
class KnowledgeBaseManager:
    ...
    def __init__(self):
        ...
        self._session_service: KnowledgeBaseService = SessionService.instance
    ...
    def create_knowledge_base(
        ...
        try:
            ...
            raise ServiceException(f"Failed to create knowledge base: {str(e)}") from e
    ...
    def delete_knowledge_base(self, id: str) -> Tuple[Dict[str, Any], str]:
        ...
        try:
            ...
            raise ServiceException(f"Failed to delete knowledge base: {str(e)}") from e
